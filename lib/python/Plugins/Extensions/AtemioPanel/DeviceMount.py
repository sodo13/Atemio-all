...
from plugin import GetSkinPath
...
class DevicesPanel(Screen):
	...
	def __init__(self, session):
		...
		self['actions'] = ActionMap(['WizardActions', 'ColorActions', "MenuActions"], {'back': self.close, 'green': self.SetupMounts, 'red': self.Format, 'yellow': self.Unmount, 'blue': self.Mount, "menu": self.close})
